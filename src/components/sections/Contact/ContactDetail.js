  ...
  return (
    <div className='container overlay-section'>
        ...
        <Grid container spacing={1}>
            <Grid item xs={12} sm={12} md={6} style={{display: "flex", flexDirection: "column", justifyContent: "center", textAlign: 'left'}} className="btns">
                ...
                <Typography variant='p' fontSize={'17px'} sx={{maxWidth: '360px', lineHeight: '26.86px'}}>
                    Let me know if you have any questions, we’d 
