...
export default function ContactForm() {
  const url = "https://hashtagbackend.herokuapp.com/contactus/create/";
  ...
  return (
    <Box className="Contact-form-box" data-aos="fade-up">
            ...
            <Box sx={style} style={{ color: "green" }}>
              ...
              <Link to="/">
                <Button
                  onClick={handleClose}
                  variant="contained"
                  sx={{ backgroundColor: "#00B9BC", mt: 5 }}
                >
                  Continue
                </Button>
              </Link>
      ...
      <h3
        className="hero-h1 mt-0 mb-16 reveal-from-bottom contact-h3"
