...
export default function ApplicationForm() {
  const url = `https://hashtagbackend.herokuapp.com/jobposting/create/`;
  ...
  function submitForm(event) {
    ...
    if (
      ...
      formValues.upload &&
      formValues.passion &&
      formValues.attracted &&
      formValues.portfolio &&
      formValues.linkedIn
    ) {
      if (
        formValues.fullName.length <= 20 &&
        isNaN(formValues.fullName) &&
        regex.test(formValues.email) &&
        regexURL.test(formValues.linkedIn) &&
        !isNaN(formValues.phoneNumber, formValues.passion)
      ) {
        console.log(formValues);
        SendData(
          tag,
  ...
  return (
    <ThemeProvider theme={theme}>
          ...
          <Modal keepMounted open={open} onClose={handleClose}>
            <Box sx={style} style={{ color: "red" }}>
              ...
              >
                ...
                {error.passion} {error.phoneNumber} {error.attracted}{" "}
                {error.linkedIn}
      ...
      {!Object.keys(error).length && valid && (
        <center>
          <Modal keepMounted open={open} onClose={handleClose}>
            <Box sx={style} style={{ color: "green" }}>
              ...
              <Typography
                ...
                sx={{ mt: 2, mb: 3 }}
              >
                A message has been sent to your email, our team will get back to
                you shortly.
              </Typography>
        ...
        <Grid container spacing={4} sx={{ marginTop: "1%", color: "#000000" }}>
          ...
          <Grid item xs={12} sm={12} md={12}>
            ...
            {formValues.upload && (
              ...
              >
                <CheckCircleIcon
                  sx={{ marginLeft: "5px", fontSize: "20px", color: "green" }}
                />
                <Typography
                  variant="overline"
                  gutterBottom
